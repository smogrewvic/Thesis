...
def generate(vehicle_spawn_transforms, pedestrian_spawn_transforms, autopilot_state, percentage_of_speed_limit = 30, sim_timestep = 0.05, sub_step = 0.01):
    ...
    try:
        ...
        if len(vehicle_spawn_transforms) == 0:
            spawn_points = world.get_map().get_spawn_points()
        else:
            spawn_points = []
            for point in vehicle_spawn_transforms:
